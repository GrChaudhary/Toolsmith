...
const MESSAGE_PAIRS = {
  ...
  'diagram.description.funnel': ['A customer-journey funnel diagram generated by Archify.', '由 Archify 生成的客户旅程漏斗图。'],
  'funnel.detail.decision': ['Decision', '决策'],
  'funnel.detail.actions': ['Actions', '客户操作'],
  'funnel.detail.touchpoints': ['Touchpoints', '接触点'],
  'funnel.detail.personas': ['Personas', '客户角色'],
  'funnel.detail.friction': ['Friction', '摩擦点'],
  'funnel.detail.actionOptionalTag': ['Optional', '可选'],
  'funnel.detail.transitions': ['Transitions', '流转'],
  'crosslink.detail.architecture': ['Architecture', '技术架构'],
  'crosslink.detail.customerJourneys': ['Used by customer journeys', '被以下客户旅程使用'],
  'funnel.persona.filterLabel': ['Filter by persona', '按客户角色筛选'],
  'funnel.persona.clear': ['Clear persona filter', '清除客户角色筛选'],
  'funnel.persona.noStagesApply': ['No stages apply to {label}', '没有阶段适用于{label}'],
  'funnel.persona.compare.toggle': ['Compare personas', '比较客户角色'],
  'funnel.persona.compare.picker': ['Select personas to compare', '选择要比较的客户角色'],
  'funnel.persona.compare.clear': ['Clear comparison', '清除比较'],
  'funnel.persona.compare.status': ['{shared} shared · {divergent} divergent · {none} not applicable', '{shared} 个共享 · {divergent} 个分歧 · {none} 个不适用'],
  'funnel.persona.compare.empty': ['Select two or more personas to compare their journeys.', '选择两个或以上客户角色以比较其旅程。'],
  'funnel.path.filterLabel': ['Path to conversion', '通向转化的路径'],
  'funnel.path.choosePlaceholder': ['Show path from…', '显示起点…'],
  'funnel.path.clear': ['Clear path', '清除路径'],
  'funnel.path.summary': ['{count} stage(s) to {target}.', '距离{target}还有 {count} 个阶段。'],
  'funnel.path.unreachable': ['No conversion is reachable from {label}.', '从{label}无法到达任何转化点。'],
  'funnel.path.otherReachable': ['{count} other conversion point(s) also reachable.', '还有 {count} 个转化点也可到达。'],
  ...
  'viewer.preset.contrast': ['Contrast', '高对比'],
  'viewer.preset.contrast.hint': ['Minimal, high-contrast review', '简约高对比评审'],
  ...
  'viewer.guided.caption.related': ['Related', '相关'],
  ...
  'viewer.passport.detailGroups': ['Additional detail', '更多详情'],
